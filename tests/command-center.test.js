...
assert.match(app, /intelligenceLayer\.evaluate\(/, "Command Center 未接入 Travel Intelligence Layer");
...
assert.match(app, /Weather Intelligence|Recommendation|Travel Health Score|Travel Memory 2\.0/, "Travel Intelligence 展示不完整");
assert.match(app, /privateMode \? `<article class="card expense-insight/, "公开模式未隔离 Expense Insight");
