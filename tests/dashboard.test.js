...
assert.equal(data.meta.version, "1.6.2", "版本未更新");
assert.equal(data.meta.versionName, "Travel Brain Core", "版本名称未更新");
...
assert.ok(index.indexOf("js/flight-watcher.js") < index.indexOf("js/travel-context.js") && index.indexOf("js/travel-context.js") < index.indexOf("js/timeline-engine.js") && index.indexOf("js/timeline-engine.js") < index.indexOf("js/app.js"), "Travel Brain 脚本加载顺序错误");
assert.match(serviceWorker, /CACHE_VERSION = "v1\.6\.2"/, "Service Worker缓存版本未更新");
