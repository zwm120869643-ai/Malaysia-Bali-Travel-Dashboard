...
assert.equal(data.meta.version, "1.4.3", "版本未更新");
assert.equal(data.meta.versionName, "Private-Public Bridge", "版本名称未更新");
...
assert.match(serviceWorker, /v1\.4\.3/, "Service Worker缓存版本未更新");
