...
assert.equal(data.meta.version, "1.6.3", "版本未更新");
assert.equal(data.meta.versionName, "Travel Assistant Experience", "版本名称未更新");
...
assert.ok(index.indexOf("js/flight-watcher.js") < index.indexOf("js/travel-context.js") && index.indexOf("js/travel-context.js") < index.indexOf("js/timeline-engine.js") && index.indexOf("js/timeline-engine.js") < index.indexOf("js/preparation-engine.js") && index.indexOf("js/preparation-engine.js") < index.indexOf("js/location-context.js") && index.indexOf("js/location-context.js") < index.indexOf("js/briefing-engine.js") && index.indexOf("js/briefing-engine.js") < index.indexOf("js/app.js"), "Travel Assistant 脚本加载顺序错误");
assert.match(serviceWorker, /CACHE_VERSION = "v1\.6\.3"/, "Service Worker缓存版本未更新");
