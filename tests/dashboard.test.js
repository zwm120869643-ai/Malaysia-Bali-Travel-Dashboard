...
assert.equal(data.meta.version, "1.5.5", "版本未更新");
assert.equal(data.meta.versionName, "Travel Day Mode", "版本名称未更新");
...
assert.match(serviceWorker, /CACHE_VERSION = "v1\.5\.5"/, "Service Worker缓存版本未更新");
