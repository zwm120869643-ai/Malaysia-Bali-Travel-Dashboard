...
assert.equal(data.meta.version, "1.5.3", "版本未更新");
assert.equal(data.meta.versionName, "Experience Upgrade", "版本名称未更新");
...
assert.match(serviceWorker, /CACHE_VERSION = "v1\.5\.3"/, "Service Worker缓存版本未更新");
