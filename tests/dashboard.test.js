...
assert.equal(data.meta.version, "1.6.1", "版本未更新");
assert.equal(data.meta.versionName, "Travel Brain", "版本名称未更新");
...
assert.match(serviceWorker, /CACHE_VERSION = "v1\.6\.1"/, "Service Worker缓存版本未更新");
