...
assert.equal(data.meta.version, "1.6.4", "版本未更新");
assert.equal(data.meta.versionName, "Travel Intelligence Layer", "版本名称未更新");
...
assert.ok(index.indexOf("js/flight-watcher.js") < index.indexOf("js/travel-context.js") && index.indexOf("js/travel-context.js") < index.indexOf("js/timeline-engine.js") && index.indexOf("js/timeline-engine.js") < index.indexOf("js/preparation-engine.js") && index.indexOf("js/preparation-engine.js") < index.indexOf("js/location-context.js") && index.indexOf("js/location-context.js") < index.indexOf("js/briefing-engine.js") && index.indexOf("js/briefing-engine.js") < index.indexOf("js/intelligence-engine.js") && index.indexOf("js/intelligence-engine.js") < index.indexOf("js/app.js"), "Travel Intelligence 脚本加载顺序错误");
assert.match(serviceWorker, /CACHE_VERSION = "v1\.6\.4"/, "Service Worker缓存版本未更新");
assert.match(serviceWorker, /js\/flight-watcher\.js/, "Flight Watcher客户端未加入应用壳");
assert.match(serviceWorker, /js\/travel-context\.js/, "Travel Context未加入应用壳");
assert.match(serviceWorker, /js\/timeline-engine\.js/, "Timeline Engine未加入应用壳");
assert.match(serviceWorker, /js\/preparation-engine\.js/, "Preparation Engine未加入应用壳");
assert.match(serviceWorker, /js\/location-context\.js/, "Location Context未加入应用壳");
assert.match(serviceWorker, /js\/briefing-engine\.js/, "Briefing Engine未加入应用壳");
assert.match(serviceWorker, /js\/intelligence-engine\.js/, "Intelligence Engine未加入应用壳");
