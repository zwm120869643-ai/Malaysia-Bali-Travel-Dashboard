...
const REQUIRED_FILES = [
  ...
  "supabase/functions/flight-watcher/index.ts",
  "supabase/travel_command_center.sql",
  "tests/command-center.test.js",
  "tests/dashboard.test.js",
  "tests/expense-ledger.test.js",
  "tests/flight-watcher.test.js",
  "tests/travel-brain.test.js",
  "tests/travel-assistant-experience.test.js",
  "tests/travel-intelligence.test.js",
...
(async () => {
  ...
  assert.equal(version, "v1.6.4", "Service Worker 缓存版本错误");
  ...
  assert.deepEqual([...stores.get(cacheName).keys()].sort(), [...shell].sort(), "v1.6.4 应用壳缓存不完整");
  ...
  assert.equal(stores.has(cacheName), true, "v1.6.4 缓存被误删");
  ...
  console.log(`v1.6.4 release candidate: ok${process.argv.includes("--release") ? " (Git ready)" : ""}`);
